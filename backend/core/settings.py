...
SECRET_KEY = 'django-insecure--)$yzfnc-j6ahxtzes0dc#2qf&niocihtp%4sy65ou-9mz80@m'
...
AUTH_USER_MODEL = 'account.User'  # Use your custom user model

AUTHENTICATION_BACKENDS = [
    'account.backend.EmailAuthBackend',  # Use your custom backend (if applicable)
